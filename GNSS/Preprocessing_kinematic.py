...
#         vz = np.polyval(coefVZ, t_hat)
    ...
    def navigationSolution(self, obs, ):
        pass
...
if __name__ == '__main__':
    ...
    Nepochs = np.int(np.round((endTime.mjd - beginTime.mjd) * 86400) / interval + 1)
    nSat = 35
    ...
    while True:
        ...
        if Rinexdata['mjd'] < beginTime: continue
        GPS, Leo = brdc.Kinematic(Rinexdata['mjd'], Rinexdata['C1'], Rinexdata['prns'], recClcDrift = 1)
        leo = Leo['leoPos'][0:3]
